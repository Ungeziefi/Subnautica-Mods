...
namespace Ungeziefi.Better_Scanner_Blips_Remake
{
    ...
    {
        private static bool IsCameraDroneActive()
        {
            MapRoomCamera camera = Object.FindObjectOfType<MapRoomCamera>();
            return camera != null && camera.liveMixin.IsAlive() && camera.IsControlled();
        }
            ...
            bool ___visible)
        {
            ...
            bool inBase = Player.main.IsInBase();
            bool isCameraDroneActive = inBase ? IsCameraDroneActive() : false;
            ...
            for (int i = 0; i < resourceCount; i++)
            {
                ...
                bool shouldHideInHabitat = Main.Config.HideBlipsInsideHabitats && inBase && !isCameraDroneActive;
