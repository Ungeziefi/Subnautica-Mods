...
{
    [Toggle(
        "<color=#FFAC09FF>Player</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    public bool PlayerDivider;

    [Toggle(Label = "Enable feature")] public bool PCEnableFeature = true;

    [Toggle(Label = "Instant zoom")] public bool PCInstantZoom = false;
    ...
    [Toggle(
        "<color=#FFAC09FF>Vehicles</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    public bool VehiclesDivider;

    [Toggle(Label = "Enable feature")] public bool VCEnableFeature = true;

    [Toggle(Label = "Instant zoom")] public bool VCInstantZoom = false;
    ...
    [Toggle(
        "<color=#FFAC09FF>Cyclops Cameras</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    public bool CyclopsCamerasDivider;

    [Toggle(Label = "Enable feature")] public bool CCEnableFeature = true;

    [Toggle(Label = "Use stepped zoom",
        Tooltip = "When enabled, zoom changes in discrete steps rather than continuously.")]
    ...
    [Toggle(Label = "Use blink effect",
        Tooltip = "When enabled, the screen briefly fades to black during stepped zoom transitions.")]
    ...
    [Toggle(
        "<color=#FFAC09FF>Camera Drones</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    public bool CameraDronesDivider;

    [Toggle(Label = "Enable feature")] public bool CDEnableFeature = true;
