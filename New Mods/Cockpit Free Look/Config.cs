...
{
    [Toggle(Label = "Hold key mode",
        Tooltip = "When enabled, you must hold the key to free look instead of toggling it.")]
    public bool HoldKeyMode = false;

    [Slider(Label = "Return duration",
        Tooltip = "How long it takes to return to the locked camera position when disabling free look.",
    ...
    [Toggle(
        "<color=#FFAC09FF>Seamoth</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    public bool SeamothDivider;

    [Toggle(Label = "Enable feature")] public bool SeamothEnableFeature = true;
    ...
    [Toggle(
        "<color=#FFAC09FF>PRAWN Suit</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    public bool PRAWNSuitDivider;

    [Toggle(Label = "Enable feature")] public bool PRAWNEnableFeature = true;
