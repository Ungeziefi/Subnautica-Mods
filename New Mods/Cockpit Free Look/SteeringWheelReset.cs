...
public partial class CockpitFreeLook
{
    private static bool IsInFreeLook(Vehicle vehicle)
    {
        ...
        {
            // Transition speed
            var smoothSpeed = Time.deltaTime * (1f / Main.Config.FreeLookReturnDuration);
            ...
            {
                var currentYaw = vehicle.mainAnimator.GetFloat("view_yaw");
                var currentPitch = vehicle.mainAnimator.GetFloat("view_pitch");
