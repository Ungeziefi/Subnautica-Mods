...
public class Config : ConfigFile
{
    ...
    [Toggle(Label = "Custom slot sizes")] public bool CustomSlotSizes = false;
    ...
    [Slider(Label = "Destruction delay (seconds)",
        Tooltip = "How long items stay in the trashcan before being destroyed.", DefaultValue = 5, Min = 0, Max = 30,
        Step = 1)]
    ...
    [Slider(Label = "Destruction interval (seconds)", Tooltip = "How frequently items are destroyed from the trashcan.",
        DefaultValue = 1, Min = 0.1f, Max = 5, Step = 0.1f)]
