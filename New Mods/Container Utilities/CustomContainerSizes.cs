...
internal class CustomContainerSizes
{
    ...
    private static void FiltrationMachine_Start(FiltrationMachine __instance)
    {
        ...
        var totalSlots = Main.Config.FiltrationWidth * Main.Config.FiltrationHeight;

        // Adjust max water/salt
        var requestedTotal = Main.Config.FiltrationMaxWater + Main.Config.FiltrationMaxSalt;
