...
public class CustomSlotSizes
{
    ...
    public static bool TechData_GetItemSize(TechType techType, ref Vector2int __result)
    {
        ...
        if (customItemSizes.TryGetValue(techType, out var customSize))
        {
            __result = customSize;
            return false;
        }
...
public class CompactItemSizeOverrideConverter : JsonConverter<Config.ItemSizeOverride>
{
    ...
    public override Config.ItemSizeOverride ReadJson(JsonReader reader, Type objectType,
        Config.ItemSizeOverride existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
        ...
        while (reader.TokenType != JsonToken.EndObject)
        {
            ...
            {
                var sizeStr = reader.Value.ToString();
