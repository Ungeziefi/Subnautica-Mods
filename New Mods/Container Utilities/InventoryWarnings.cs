        ...
        private static void UpdateWarnings(Inventory inventory)
        {
            ...
            if (Main.Config.ShowFullInventoryWarning && isFullNow && !wasInventoryFull)
            {
                ...
                if (Main.Config.FullInventoryAudioCue)
                    FMODUWE.PlayOneShot(
                    Nautilus.Utility.AudioUtils.GetFmodAsset("event:/interface/ping"), // https://github.com/SubnauticaModding/Nautilus/blob/master/Nautilus/Documentation/resources/SN1-FMODEvents.txt
