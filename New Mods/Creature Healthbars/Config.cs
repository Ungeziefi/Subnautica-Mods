...
public class Config : ConfigFile
{
    ...
    [Slider(Label = "Display duration",
        Tooltip = "How long the health bar remains visible after taking damage (in seconds).",
    ...
    [Toggle(Label = "Show name")] public bool ShowName = false;
    ...
    [Slider(Label = "Bar ratio",
        Tooltip = "Width-to-height ratio of the health bar. Higher values make wider, thinner bars.",
        DefaultValue = 8.0f, Min = 4.0f, Max = 16.0f, Step = 1.0f, Format = "{0:0.0}")]
    public float BarRatio = 8.0f;

    [Slider(Label = "Height padding",
        Tooltip = "Space between the creature and its health bar (as % of creature height).",
        DefaultValue = 0f, Min = -1.0f, Max = 1.0f, Step = 0.1f, Format = "{0:0.0}")]
    public float HeightPadding = 0f;

    [Toggle(
        "<color=#FFAC09FF>Sprite</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    ...
    [Slider(Label = "Corner roundness", DefaultValue = 0.250f, Min = 0.0f, Max = 0.5f, Step = 0.025f,
        Format = "{0:0.000}")]
    public float CornerRoundness = 0.250f;

    [Toggle(
        "<color=#FFAC09FF>Health color</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    ...
    [Toggle(
        "<color=#FFAC09FF>Background color</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
    ...
    [Toggle(
        "<color=#FFAC09FF>Debug</color> <alpha=#00>----------------------------------------------------------------------------</alpha>")]
