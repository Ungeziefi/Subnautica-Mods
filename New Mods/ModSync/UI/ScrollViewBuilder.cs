...
public static class ScrollViewBuilder
{
    ...
    {
        var originalLayout = textToReplace.GetComponent<LayoutElement>();
        var textRect = textToReplace.GetComponent<RectTransform>();
        ...
        var layout = scrollView.AddComponent<LayoutElement>();
        ...
        var siblingIndex = textToReplace.GetSiblingIndex();
    ...
    {
        var scrollbarTemplate =
            GameObject.Find("Menu canvas/Panel/MainMenu/RightSide/SavedGames/Scroll View/Scrollbar");
        var scrollbar = Object.Instantiate(scrollbarTemplate, parent, false);
    ...
    public static void ConfigureContent(GameObject scrollView, string message)
    {
        ...
        if (scrollRectComponent != null) scrollRectComponent.content = contentRect;
    }
}