...
public class Config : ConfigFile
{
    ...
    [Slider(Label = "PDA bobbing speed", Tooltip = "Controls the frequency of the bobbing.", DefaultValue = 2.0f,
        Min = 0.1f, Max = 10.0f, Step = 0.1f, Format = "{0:0.0}")]
    public float PDABobbingSpeed = 2.0f;

    [Slider(Label = "PDA bobbing amount", Tooltip = "Controls the amplitude of the bobbing.", DefaultValue = 0.2f,
        Min = 0.01f, Max = 1.0f, Step = 0.01f, Format = "{0:0.0}")]
