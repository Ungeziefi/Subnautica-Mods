...
public class PDAMovementandBobbing
{
    ...
    private static void ApplyBobbing(Player instance)
    {
        ...
        var bobOffset = Mathf.Sin(bobTime * Main.Config.PDABobbingSpeed) * Main.Config.PDABobbingAmount;
    ...
    public static bool Player_Update(Player __instance)
    {
        ...
        // Movement blocking
        var isSwimming = Player.main.IsSwimming();
    ...
    [HarmonyPatch(typeof(GameInput), nameof(GameInput.GetMoveDirection))]
    [HarmonyPrefix]
