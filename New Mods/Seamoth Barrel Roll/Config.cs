...
public class Config : ConfigFile
{
    ...
    [Slider(Label = "Roll force", Tooltip = "How strong the rolling motion is.", DefaultValue = 20f, Min = 10f,
        Max = 50f, Step = 1)]
    public float RollForce = 20f;

    [Slider(Label = "Roll acceleration", Tooltip = "How quickly the roll builds up (0 is disabled).",
        DefaultValue = 20f, Min = 0f, Max = 100f, Step = 1)]
    ...
    [Toggle(Label = "Star Fox sound",
        Tooltip = "Plays the Star Fox \"Do a barrel roll\" when pressing down the roll keys.")]
