...
{
    [HarmonyPatch(typeof(AggressiveWhenSeeTarget), nameof(AggressiveWhenSeeTarget.IsTargetValid))]
    [HarmonyPostfix]
    [HarmonyPatch(new[] { typeof(GameObject) })]
    public static void AggressiveWhenSeeTarget_IsTargetValid(AggressiveWhenSeeTarget __instance, ref bool __result,
        GameObject target)
    {
