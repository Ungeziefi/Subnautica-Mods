...
public class DockingBaySoundChecks
{
    ...
    [HarmonyPatch(typeof(VehicleDockingBay), nameof(VehicleDockingBay.LaunchbayAreaEnter))]
    [HarmonyTranspiler]
    public static IEnumerable<CodeInstruction> VehicleDockingBay_LaunchbayAreaEnter(
        IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        ...
        matcher.MatchForward(false,
            ...
            new CodeMatch(OpCodes.Callvirt,
                AccessTools.Method(typeof(FMOD_CustomEmitter), nameof(FMOD_CustomEmitter.Play))));
        ...
        matcher.Insert(
            ...
            new CodeInstruction(OpCodes.Call,
                AccessTools.Method(typeof(VehicleDockingBay), nameof(VehicleDockingBay.GetDockedVehicle))),
    ...
    [HarmonyPatch(typeof(VehicleDockingBay), nameof(VehicleDockingBay.LaunchbayAreaExit))]
    [HarmonyTranspiler]
    public static IEnumerable<CodeInstruction> VehicleDockingBay_LaunchbayAreaExit(
        IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        if (!Main.Config.DockingBaySoundChecks) return instructions;
        ...
        matcher.Insert(
            ...
            new CodeInstruction(OpCodes.Ldarg_0), // Load "this"
            new CodeInstruction(OpCodes.Call,
                AccessTools.Method(typeof(VehicleDockingBay), nameof(VehicleDockingBay.IsPowered))),
