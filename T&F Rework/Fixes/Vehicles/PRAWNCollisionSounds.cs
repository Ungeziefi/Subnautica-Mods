...
public class PRAWNCollisionSounds
{
    ...
    public static void Exosuit_Start(Exosuit __instance)
    {
        ...
        var collisionSound = __instance.gameObject.EnsureComponent<CollisionSound>();

        // Create and assign FMOD assets
        collisionSound.hitSoundSmall =
            CreateFMODAsset("event:/sub/common/fishsplat", "{0e47f1c6-6178-41bd-93bf-40bfca179cb6}");
        collisionSound.hitSoundFast = CreateFMODAsset("event:/sub/seamoth/impact_solid_hard",
            "{ed65a390-2e80-4005-b31b-56380500df33}");
        collisionSound.hitSoundMedium = CreateFMODAsset("event:/sub/seamoth/impact_solid_medium",
            "{cb2927bf-3f8d-45d8-afe2-c82128f39062}");
        collisionSound.hitSoundSlow = CreateFMODAsset("event:/sub/seamoth/impact_solid_soft",
            "{15dc7344-7b0a-4ffd-9b5c-c40f923e4f4d}");
    }

    [HarmonyPatch(typeof(CollisionSound), nameof(CollisionSound.OnCollisionEnter))]
    [HarmonyPrefix]
