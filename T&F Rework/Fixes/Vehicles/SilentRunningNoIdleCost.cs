...
public class SilentRunningNoIdleCost
{
    ...
    [HarmonyPatch(typeof(PowerRelay), nameof(PowerRelay.ModifyPower))]
    [HarmonyPostfix]
    ...
    [HarmonyPatch(typeof(CyclopsSilentRunningAbilityButton),
        nameof(CyclopsSilentRunningAbilityButton.SilentRunningIteration))]
    [HarmonyPrefix]
    public static void CyclopsSilentRunningAbilityButton_SilentRunningIteration(
        CyclopsSilentRunningAbilityButton __instance)
    {
