...
public class ScannerRoomSpeedMultiplier
{
    ...
    public static bool MapRoomFunctionality_UpdateScanRangeAndInterval_Prefix(MapRoomFunctionality __instance)
    {
        ...
        var speedUpgradeCount = __instance.storageContainer.container.GetCount(TechType.MapRoomUpgradeScanSpeed);
        __instance.scanInterval = Mathf.Max(1f,
            VANILLA_SCAN_INTERVAL * Main.Config.ScannerRoomSpeedMultiplier - speedUpgradeCount * 3f);
