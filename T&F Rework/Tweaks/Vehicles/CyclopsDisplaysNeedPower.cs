...
public class CyclopsDisplaysNeedPower
{
    public static void UpdateDisplayComponents(SubRoot cyclops, bool isPowered)
    {
        ...
        SetActive(cyclops.GetComponentInChildren<CyclopsVehicleStorageTerminalManager>().transform.Find("GUIScreen"),
            isPowered);
        ...
        SetActive(cyclops.transform.Find("SubName").Find("VolumetricLight"),
            isPowered); // Volumetric light below SubName
    ...
    public static bool CyclopsHelmHUDManager_Update(CyclopsHelmHUDManager __instance)
    {
        ...
        var isPowered = powerRelay != null && powerRelay.IsPowered();
